...
3. **Agregasi:** Menghitung tingkat konfirmasi dengan menggunakan rumus berikut:
    * Jumlah pesan yang dikonfirmasi : menjumlahkan dengan syarat `CASE WHEN` pesan terkonfirmasi, jika pesan terkonfirmasi maka tampilkan(`THEN`) 1, jika tidak maka tampilkan (`ELSE`) 0, lalu menjumlahkan total pesan terkonfirmasi menggunakan fungsi aggregat `SUM`. Kemudian dibagi dengan,
